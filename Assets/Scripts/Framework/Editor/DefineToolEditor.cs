...
public class DefineToolEditor : EditorWindow
{
    //-----------------static-----------------------
    [MenuItem("XYFramework/设置宏定义工具")]
    public static void Open()
    {
        EditorWindow.GetWindow<DefineToolEditor>(true, "设置宏定义");
    }

    private DefineData[] mDefineList;
    private Vector2 mScrollView = new Vector2();

    private const string TEMPLETE_PATH = "Assets/Define.txt";
