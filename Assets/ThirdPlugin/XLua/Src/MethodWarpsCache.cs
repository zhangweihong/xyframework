...
namespace XLua
{
        ...
        public int Call(RealStatePtr L)
        {
            try
            {
                ...
                if (method.IsDefined(typeof(ObsoleteAttribute), true))
                {
                    ...
                    Debug.LogWarning("Obsolete Method [" + method.DeclaringType.ToString() + "." + method.Name + "]: " + info.Message);
                } 
#endif
                object target = null;
                ...
                for (int i = 0; i < castArray.Length; i++)
                {
                    ...
                    //Debug.Log("value:" + args[inPosArray[i]]);
                }
                ...
                if (!isVoid)
                {
                    //Debug.Log(toInvoke.ToString() + " ret:" + ret);
    ...
    public class MethodWrapsCache
    {
        ...
        {
            //Debug.LogWarning("GetConstructor:" + type);
        ...
        {
            //Debug.LogWarning("GetMethodWrap:" + type + " " + methodName);
        ...
        {
            //Debug.LogWarning("GetDelegateWrap:" + type );
